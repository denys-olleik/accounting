...
{
    public class CreateCustomerViewModelValidator : AbstractValidator<CreateBusinessEntityViewModel>
    {
        ...
        private bool BeAValidBusinessEntityType(string selectedBusinessEntityTypesCsv)
        {
            ...
            return selectedTypes.All(x => BusinessEntityTypeConstants.All.Contains(x)); 
        }
