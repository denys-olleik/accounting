...
namespace Accounting.Database.Interfaces
{
  public interface IInvoiceInvoiceLinePaymentManager : IGenericRepository<InvoiceInvoiceLinePayment, int>
  {
    ...
    Task<(List<InvoiceInvoiceLinePayment> invoicePayments, int? nextPage)> SearchInvoicePaymentsAsync(int page, int pageSize, string searchQuery, List<string> typesToLoad, int organizationId);
